...
import androidx.core.view.GravityCompat; // ✅ import ĐÚNG VỊ TRÍ
...
import com.google.android.material.navigation.NavigationView; // ✅ import
...
public class MenuActivity extends AppCompatActivity {
    ...
    private NavigationView navigationView; // ✅ dùng type đã import
    ...
    private void setupClickListeners() {
        ivMenu.setOnClickListener(v -> {
            if (drawerLayout.isDrawerOpen(GravityCompat.END)) {
                drawerLayout.closeDrawer(GravityCompat.END);  // ✅ dùng GravityCompat.END
            } else {
                drawerLayout.openDrawer(GravityCompat.END);   // ✅ dùng GravityCompat.END
            }
        });
